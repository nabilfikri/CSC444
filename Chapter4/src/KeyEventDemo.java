...
/**
 * Sample program to demostrate key event
 * @author Muhammad Nabil Fikri
 * @since v 1.0
 * @version 1.5
 *
 */
public class KeyEventDemo extends JFrame {
  ...
  /**
   * To construct KeyEventDemo object
   */
  public KeyEventDemo() {
   ...
   * @param price Price of a good
   * @param percent Discount percentage
   * @return Discounted price of a good
   */
  public double calcDiscount(double price, double percent){
